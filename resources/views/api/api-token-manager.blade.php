<div>
    ...
    <x-jetstream.form-section submit="createApiToken">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-jetstream.input id="name" type="text" class="mt-1 block w-full"
        ...
        <x-slot name="actions">
            <x-jetstream.action-message class="me-3" on="created">
                {{ __('Created.') }}
    ...
    <x-jetstream.dialog-modal wire:model.live="managingApiTokenPermissions">
        ...
        <x-slot name="footer">
            <x-jetstream.secondary-button wire:click="$set('managingApiTokenPermissions', false)"
    ...
    <x-jetstream.confirmation-modal wire:model.live="confirmingApiTokenDeletion">
        ...
        <x-slot name="footer">
            <x-jetstream.secondary-button wire:click="$toggle('confirmingApiTokenDeletion')"
                wire:loading.attr="disabled">
                {{ __('Cancel') }}
            </x-jetstream.secondary-button>

            <x-jetstream.danger-button class="ms-3" wire:click="deleteApiToken" wire:loading.attr="disabled">
                {{ __('Delete') }}

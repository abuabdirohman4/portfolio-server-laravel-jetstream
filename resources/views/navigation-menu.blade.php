        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-jetstream.nav-link href="{{ route('skills') }}" :active="request()->routeIs('skills')">
                        {{ __('Skills') }}
                    </x-jetstream.nav-link>
                </div>
            </div>
                    ...
                    <x-jetstream.dropdown align="right" width="48">
                                ...
                                {{-- @else --}}
                                    <span class="inline-flex rounded-md">
                                        <button type="button"
                                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                            {{ Auth::user()->name }}
                                            <img class="ms-2 -me-0.5 h-8 w-8 rounded-full object-cover"
                        ...
                        <x-slot name="content">
                            ...
                            <form method="POST" action="{{ route('logout') }}" x-data>
                                ...
                                <x-jetstream.dropdown-link href="{{ route('logout') }}"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                <x-jetstream.responsive-nav-link href="{{ route('profile.show') }}" :active="request()->routeIs('profile.show')">
                    {{ __('Profile') }}
                </x-jetstream.responsive-nav-link>
                ...
                @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                    ...
                    <!-- Team Settings -->
                    <x-jetstream.responsive-nav-link href="{{ route('teams.show', Auth::user()->currentTeam->id) }}"

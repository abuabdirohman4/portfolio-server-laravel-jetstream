<x-jetstream.form-section submit="updatePassword">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jetstream.input id="current_password" type="password" class="mt-1 block w-full"
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jetstream.input id="password" type="password" class="mt-1 block w-full" wire:model="state.password"
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jetstream.input id="password_confirmation" type="password" class="mt-1 block w-full"

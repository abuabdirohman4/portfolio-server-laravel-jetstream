    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{ photoName: null, photoPreview: null }" class="col-span-6 sm:col-span-4">
                ...
                <x-jetstream.secondary-button class="mt-2 me-2" type="button" x-on:click.prevent="$refs.photo.click()">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jetstream.input id="name" type="text" class="mt-1 block w-full" wire:model="state.name" required
                autocomplete="name" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jetstream.input id="email" type="email" class="mt-1 block w-full" wire:model="state.email" required

<x-jetstream.action-section>
    ...
    <x-slot name="content">
        ...
        <x-jetstream.dialog-modal wire:model.live="confirmingUserDeletion">
            ...
            <x-slot name="footer">
                <x-jetstream.secondary-button wire:click="$toggle('confirmingUserDeletion')"
                    wire:loading.attr="disabled">
                    {{ __('Cancel') }}
                </x-jetstream.secondary-button>

                <x-jetstream.danger-button class="ms-3" wire:click="deleteUser" wire:loading.attr="disabled">
                    {{ __('Delete Account') }}
                </x-jetstream.danger-button>
            </x-slot>
